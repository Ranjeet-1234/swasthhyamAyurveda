                ...
                <div className="mt-14 sm:mt-20 text-center">
                    <div className="bg-gradient-to-r from-emerald-600 to-green-600 rounded-3xl p-6 sm:p-10 shadow-2xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <a href="tel:+919876543210" className="bg-emerald-700 hover:bg-emerald-800 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold transition-all duration-300 hover:scale-105 border-2 border-emerald-500 text-center">
                                Call Us Now
                            </a>
